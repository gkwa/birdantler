...
import (
	...
	"github.com/gkwa/birdantler/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.birdantler.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".birdantler")
	}
